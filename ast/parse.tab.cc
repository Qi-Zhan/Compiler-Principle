,    39,    40,    41,    42,    43,    44,    45,    46,    47,
      50,   114,   125,    53,    41,    54,    42,    53,    39,    40,
      41,    87,    54,    39,    40,    41,    39,    42,   131,   132,
     133,    57,    39,    40,    41,    56,    57,   140,    42,   142,
      56,   144,    57,    81,    51,    48,    49,    87,    54,    56,
      52,    55,    15,    16,    39,     3,    56,    20,    21,    22,
      23,    99,    43,   101,   102,   103,   104,    15,    16,    43,
      51,    52,    20,    21,    22,    23,    56,    51,    52,    56,
      56,    29,    56,    31,    32,    51,    34,    35,    36,    37,
      38,    39,    40,    41,    57,    51,   134,     3,     5,     6,
       7,     8,     9,    51,    39,    39,    54,    55,    56,    15,
      16,    53,    51,    53,    20,    21,    22,    23,    46,    47,
      48,    49,    52,    29,    51,    31,    32,     3,    34,    35,
      36,    37,    38,    39,    40,    41,    30,    44,    45,    46,
      47,    48,    49,     7,    87,    51,   101,    12,    54,    55,
      56,     0,    -1,    29,    -1,    31,    32,     3,    34,    35,
      36,    37,    38,    39,    40,    41,    15,    16,    -1,    -1,
      -1,    20,    21,    22,    23,    51,    15,    16,    54,    55,
      56,    20,    21,    29,    23,    31,    32,     3,    34,    35,
      36,    37,    38,    39,    40,    41,     3,    -1,    -1,    -1,
      -1,    -1,    -1,    -1,    -1,    51,    -1,    -1,    54,    55,
      56,    -1,    -1,    29,    -1,    31,    32,    -1,    34,    35,
      36,    37,    38,    39,    40,    41,     5,     6,     7,     8,
       9,    10,    39,    40,    41,    51,    -1,    -1,    54,    -1,
      56,    -1,    -1,    -1,    51,    -1,    -1,    -1,    -1,    56,
       5,     6,     7,     8,     9,    10,    -1,     5,     6,     7,
       8,     9,    10,    -1,    43,    44,    45,    46,    47,    48,
      49,    -1,     5,     6,     7,     8,     9,    10,    57,     5,
       6,     7,     8,     9,    10,    -1,    -1,    -1,    43,    44,
      45,    46,    47,    48,    49,    43,    44,    45,    46,    47,
      48,    49,    57,     5,     6,     7,     8,     9,    10,    57,
      43,    44,    45,    46,    47,    48,    49,    43,    44,    45,
      46,    47,    48,    49,    57,     5,     6,     7,     8,     9,
      10,    57,    -1,    -1,     5,     6,     7,     8,     9,    10,
      -1,    43,    44,    45,    46,    47,    48,    49,    -1,    -1,
      -1,    53,     5,     6,     7,     8,     9,    10,    -1,    -1,
      -1,    -1,    -1,    43,    44,    45,    46,    47,    48,    49,
      -1,    51,    43,    44,    45,    46,    47,    48,    49,    -1,
      51,     5,     6,     7,     8,     9,    10,     5,     6,    -1,
      43,    44,    45,    46,    47,    48,    49,    -1,    51,     5,
       6,     7,     8,     9,    10,     5,     6,     7,     8,    -1,
      15,    16,    -1,    -1,    -1,    20,    21,    22,    23,    43,
      44,    45,    46,    47,    48,    49,    44,    45,    46,    47,
      48,    49,    -1,    -1,    -1,    -1,    -1,    -1,    44,    45,
...
{
       0,    15,    16,    20,    21,    22,    23,    61,    62,    63,
      64,    66,    77,    78,     0,    62,    39,    78,    43,    51,
      52,    56,     3,    39,    40,    41,    56,    76,    41,    57,
      64,    65,    52,    56,    76,     5,     6,     7,     8,     9,
      10,    43,    44,    45,    46,    47,    48,    49,    51,    53,
      54,    67,    39,    42,    57,    76,    71,    76,    57,    76,
      76,    76,    76,    76,    76,    76,    76,    76,    76,    76,
      76,    76,    43,    51,    29,    31,    32,    34,    35,    36,
      37,    38,    51,    55,    63,    64,    67,    68,    69,    70,
      72,    73,    74,    75,    76,    52,    64,    67,    53,    42,
      57,    54,    56,    56,    56,    56,    39,    51,    51,    51,
      76,    39,    55,    63,    69,    55,    70,    51,    53,    39,
      76,    71,    76,    76,    76,    72,    51,    51,    55,    52,
      55,    57,    57,    57,    72,    53,    51,    70,    70,    70,
      57,    76,    30,    70,    57,    70,    70
};
...
#line 1350 "parse.tab.cc"
  ...
  case 8: /* declaration: declaration_specifiers IDENTIFIER '[' CONSTANTi ']' ';'  */
#line 77 "parse.y"
                                                                {(yyval.node) = new AST("VarDecl");(yyval.node)->dtype = (yyvsp[-5].node)->tokentype+"*";(yyval.node)->ID = (yyvsp[-4].str);(yyval.node)->length =  (int)((yyvsp[-2].numi));}
#line 1356 "parse.tab.cc"
    break;

  case 9: /* declaration: declaration_specifiers IDENTIFIER '[' CONSTANTi ']' '=' '{' expression_list '}' ';'  */
#line 78 "parse.y"
                                                                                             {(yyval.node) = new AST("VarDecl");(yyval.node)->dtype = (yyvsp[-9].node)->tokentype+"*";(yyval.node)->ID = (yyvsp[-8].str);(yyval.node)->length =  (int)((yyvsp[-6].numi));(yyval.node)->child = (yyvsp[-2].node)->child;}
#line 1362 "parse.tab.cc"
    break;

  case 10: /* declaration_specifiers: type_qualifier type_specifier  */
#line 82 "parse.y"
                                        {}
...
#line 1374 "parse.tab.cc"
  ...
  case 12: /* parameter_list: declaration_specifiers IDENTIFIER  */
#line 92 "parse.y"
...
#line 1381 "parse.tab.cc"
    break;

  case 13: /* parameter_list: parameter_list ',' declaration_specifiers IDENTIFIER  */
#line 94 "parse.y"
...
#line 1388 "parse.tab.cc"
  ...
  case 14: /* parameter_list: declaration_specifiers IDENTIFIER '[' ']'  */
#line 96 "parse.y"
                                                 {
                (yyval.node) = new AST("ParmVarDecl"); AST* temp = new AST("ParmVarDecl");
                temp->ID = (yyvsp[-2].str); temp->dtype = (yyvsp[-3].node)->tokentype+"*"; (yyval.node)->insert(temp);
        }
#line 1397 "parse.tab.cc"
    break;

  case 15: /* parameter_list: parameter_list ',' declaration_specifiers IDENTIFIER '[' ']'  */
#line 100 "parse.y"
                                                                      {
                (yyval.node) = (yyvsp[-5].node); AST* temp = new AST("ParmVarDecl");
                temp->ID = (yyvsp[-2].str); temp->dtype = (yyvsp[-3].node)->tokentype+"*"; (yyval.node)->insert(temp);
        }
#line 1406 "parse.tab.cc"
    break;

  case 16: /* function_definition: declaration_specifiers IDENTIFIER '(' parameter_list ')' compound_statement  */
#line 108 "parse.y"
                                                                                      {
...
#line 1553 "parse.tab.cc"
    break;

  case 40: /* iteration_statement: FOR '(' expression_statement expression_statement expression ')' statement  */
#line 160 "parse.y"
...
#line 1559 "parse.tab.cc"
    break;

  case 41: /* jump_statement: GOTO IDENTIFIER ';'  */
#line 164 "parse.y"
                              {}
#line 1565 "parse.tab.cc"
    break;

  case 42: /* jump_statement: CONTINUE ';'  */
#line 165 "parse.y"
                       {(yyval.node) =  new AST("ContinueStmt");}
#line 1571 "parse.tab.cc"
    break;

  case 43: /* jump_statement: BREAK ';'  */
#line 166 "parse.y"
                    {(yyval.node) = new AST("BreakStmt");}
#line 1577 "parse.tab.cc"
    break;

  case 44: /* jump_statement: RETURN ';'  */
#line 167 "parse.y"
                     {(yyval.node) = new AST("ReturnStmt");}
#line 1583 "parse.tab.cc"
    break;

  case 45: /* jump_statement: RETURN expression ';'  */
#line 168 "parse.y"
                                {(yyval.node) = new AST("ReturnStmt"); (yyval.node)->insert((yyvsp[-1].node)); }
#line 1589 "parse.tab.cc"
    break;
...
#line 173 "parse.y"
                                    {(yyval.node) = new AST("BinaryOperator");(yyval.node)->binaryop="-"; (yyval.node)->insert((yyvsp[-2].node));(yyval.node)->insert((yyvsp[0].node));}
#line 1601 "parse.tab.cc"
    break;

  case 48: /* expression: expression '*' expression  */
#line 174 "parse.y"
                                    {(yyval.node) = new AST("BinaryOperator");(yyval.node)->binaryop="*"; (yyval.node)->insert((yyvsp[-2].node));(yyval.node)->insert((yyvsp[0].node));}
#line 1607 "parse.tab.cc"
    break;

  case 49: /* expression: expression '/' expression  */
#line 175 "parse.y"
                                    {(yyval.node) = new AST("BinaryOperator");(yyval.node)->binaryop="/"; (yyval.node)->insert((yyvsp[-2].node));(yyval.node)->insert((yyvsp[0].node));}
#line 1613 "parse.tab.cc"
    break;

  case 50: /* expression: expression AND_OP expression  */
#line 176 "parse.y"
                                       {(yyval.node) = new AST("BinaryOperator");(yyval.node)->binaryop="&&"; (yyval.node)->insert((yyvsp[-2].node));(yyval.node)->insert((yyvsp[0].node));}
#line 1619 "parse.tab.cc"
    break;

  case 51: /* expression: expression OR_OP expression  */
#line 177 "parse.y"
                                      {(yyval.node) = new AST("BinaryOperator");(yyval.node)->binaryop="||"; (yyval.node)->insert((yyvsp[-2].node));(yyval.node)->insert((yyvsp[0].node));}
#line 1625 "parse.tab.cc"
    break;

  case 52: /* expression: expression LE_OP expression  */
#line 178 "parse.y"
                                       {(yyval.node) = new AST("BinaryOperator");(yyval.node)->binaryop="<="; (yyval.node)->insert((yyvsp[-2].node));(yyval.node)->insert((yyvsp[0].node));}
#line 1631 "parse.tab.cc"
    break;

  case 53: /* expression: expression NE_OP expression  */
#line 179 "parse.y"
                                      {(yyval.node) = new AST("BinaryOperator");(yyval.node)->binaryop="!="; (yyval.node)->insert((yyvsp[-2].node));(yyval.node)->insert((yyvsp[0].node));}
#line 1637 "parse.tab.cc"
    break;

  case 54: /* expression: expression GE_OP expression  */
#line 180 "parse.y"
                                      {(yyval.node) = new AST("BinaryOperator");(yyval.node)->binaryop=">="; (yyval.node)->insert((yyvsp[-2].node));(yyval.node)->insert((yyvsp[0].node));}
#line 1643 "parse.tab.cc"
    break;

  case 55: /* expression: expression EQ_OP expression  */
#line 181 "parse.y"
                                        {(yyval.node) = new AST("BinaryOperator"); (yyval.node)->binaryop="==";(yyval.node)->insert((yyvsp[-2].node));(yyval.node)->insert((yyvsp[0].node));}
#line 1649 "parse.tab.cc"
    break;

  case 56: /* expression: expression '<' expression  */
#line 182 "parse.y"
                                      {(yyval.node) = new AST("BinaryOperator"); (yyval.node)->binaryop="<";(yyval.node)->insert((yyvsp[-2].node));(yyval.node)->insert((yyvsp[0].node));}
#line 1655 "parse.tab.cc"
    break;

  case 57: /* expression: expression '>' expression  */
#line 183 "parse.y"
                                      {(yyval.node) = new AST("BinaryOperator"); (yyval.node)->binaryop=">";(yyval.node)->insert((yyvsp[-2].node));(yyval.node)->insert((yyvsp[0].node));}
#line 1661 "parse.tab.cc"
    break;

  case 58: /* expression: expression '=' expression  */
#line 184 "parse.y"
                                    {(yyval.node) = new AST("BinaryOperator");(yyval.node)->binaryop="="; (yyval.node)->insert((yyvsp[-2].node));(yyval.node)->insert((yyvsp[0].node));}
#line 1667 "parse.tab.cc"
    break;

  case 59: /* expression: IDENTIFIER '[' expression ']'  */
#line 185 "parse.y"
                                        {(yyval.node) = new AST("ArraySubscriptExpr");AST* temp = new AST("Identifier");temp->ID = (yyvsp[-3].str);  (yyval.node)->insert(temp);(yyval.node)->insert((yyvsp[-1].node)); }
#line 1673 "parse.tab.cc"
    break;

  case 60: /* expression: IDENTIFIER '(' expression_list ')'  */
#line 186 "parse.y"
                                             {(yyval.node) = new AST("CallExpr"); (yyval.node)->ID = (yyvsp[-3].str); (yyval.node)->child = (yyvsp[-1].node)->child;}
#line 1679 "parse.tab.cc"
    break;

  case 61: /* expression: IDENTIFIER  */
#line 187 "parse.y"
                     {(yyval.node) = new AST("Identifier"); (yyval.node)->ID = (yyvsp[0].str); }
#line 1685 "parse.tab.cc"
    break;

  case 62: /* expression: CONSTANTf  */
#line 188 "parse.y"
                    {(yyval.node) = new AST("Constant"); (yyval.node)->dvalue = (yyvsp[0].numf); (yyval.node)->dtype = "float"; }
#line 1691 "parse.tab.cc"
    break;

  case 63: /* expression: CONSTANTi  */
#line 189 "parse.y"
                    {(yyval.node) = new AST("Constant"); (yyval.node)->dvalue = (yyvsp[0].numi); (yyval.node)->dtype = "int";}
#line 1697 "parse.tab.cc"
    break;

  case 64: /* expression: STRING_LITERAL  */
#line 190 "parse.y"
                         {}
#line 1703 "parse.tab.cc"
    break;
